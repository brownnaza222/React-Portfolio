    ...
    return (
        <div name='home' className='w-full h-screen bg-[#0a192f]'>
            ...
            <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
                ...
                <h1 className='text-4xl sm:text-7xl font-bold text-[#f3e2fc]'>DEVnaza Academy</h1>
                <h2 className='text-4xl sm:7xl font-bold text-[#fb38c7]'>I'm A Front-end Developer.</h2>
